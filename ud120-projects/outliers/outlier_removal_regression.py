...
convert_pkl("practice_outliers_ages.pkl")
convert_pkl("practice_outliers_net_worths.pkl")
...
try:
    ...
    print("len(ages_train):", len(ages_train))
...
if len(cleaned_data) > 0:
    ...
    try:
        ...
        print("Test score after clean:", reg.score(ages_test, net_worths_test))
        plt.plot(ages, reg.predict(ages), color="blue")
    except NameError:
