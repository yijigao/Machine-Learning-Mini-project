...
from convert_to_unix import convert_pkl
convert_pkl("../final_project/final_project_dataset_modified.pkl")
convert_pkl("../tools/python2_lesson06_keys.pkl")
...
print("slope:", reg.coef_[0],"\n",
      ...
      "Training Score: ", reg.score(feature_train, target_train),"\n",
      "Test Score:", reg.score(feature_test, target_test))
# plt.clf()
